...
var ChartApi = class {
  ...
  _private__convertMouseParams(param) {
    ...
    const hoveredSeries = param._internal_hoveredSeries === void 0 ? void 0 : this._private__mapSeriesToApi(param._internal_hoveredSeries);
    return {
